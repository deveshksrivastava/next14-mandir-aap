    ...
    return (
      <>
        ...
        <div key={index} className="relative  sm:h-[100vh] h-[60vh]    w-full">
          <div
            className={`absolute insert-0   top-0 z-10 sm:h-[100vh] h-[60vh]   overflow-hidden w-full bg-no-repeat bg-center bg-cover flex flex-col justify-center items-center  `}
            style={{
          ...
          <div className="absolute  bg-transparent z-10 sm:h-[100vh] 2xl:top-10 h-[50vh] font-serif  overflow-hidden w-full bg-no-repeat bg-cover flex flex-col justify-center items-center ">
            <h2 className=" font-bold  text-white sm:text-[4rem] lg:[3rem] 2xl:text-[7rem]  leading-tight text-2xl flex justify-center sm:p-0  p-5 z-20  ">
              {title}
            </h2>
